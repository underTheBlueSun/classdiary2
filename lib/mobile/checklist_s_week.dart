...
import 'package:classdiary2/mobile/checklist_s_week_detail.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('주간 체크현황', style: TextStyle(fontWeight: FontWeight.bold),),
      ),
                    ...
                    return StreamBuilder<QuerySnapshot>(
                        ...
                        return InkWell(
                          onTap: () {
                            ...
                            Get.to(() => ChecklistSWeekDetail(), arguments: itemCnt - index);
