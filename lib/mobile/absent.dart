              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 5,),
                    Text(doc['name'], style: TextStyle(color: Colors.black.withOpacity(0.8), fontSize: 17),),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 5,),
                          Text('결석 ${AttendanceController.to.absentCnt.value}', style: TextStyle(fontSize: 15),),
                          SizedBox(width: 10,),
                          Container(
                            width: 10,
                            height: 10,
                          ...
                          SizedBox(width: 5,),
                          Text('출석인정 ${AttendanceController.to.agreeCnt.value}', style: TextStyle(fontSize: 15),),
                        ],
                      ),
