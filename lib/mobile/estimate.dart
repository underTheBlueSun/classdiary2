...
import 'package:classdiary2/mobile/estimate_folder.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('평가', style: TextStyle(fontWeight: FontWeight.bold),),
        actions: [
          PopUpMenuWidget(),
        ],
      ),
                          ...
                          doc['esti'] == 'tripple'
                            ...
                            children: [
                              ...
                              EstiController.to.chartSelections2.contains(doc.id)
                                ...
                                child: Icon(Icons.stacked_bar_chart, color: Colors.teal.withOpacity(0.7),),
                              )
                                  : InkWell(
                                onTap: () {
