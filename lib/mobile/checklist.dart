...
import 'package:classdiary2/mobile/checklist_folder.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('체크리스트', style: TextStyle(fontWeight: FontWeight.bold),),
        actions: [
          PopUpMenuWidget(),
        ],
      ),
                          ...
                          InkWell(
                            ...
                            child: Obx(() => Row(
                              children: [
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        SizedBox(
                                          width: 210,
                                          child: Text(doc['title'], overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 17),),
                                        ),
                                      ],
                                    ),
                                    doc['gubun'] == '폴더'
                                ...
                                doc['gubun'] == '파일'
                                    ? Text(doc['numArray'].length.toString(), style: TextStyle(fontSize: 20, color: Colors.orange.withOpacity(0.7).withOpacity(0.7)),)
                                    : SizedBox(),
                                SizedBox(width: 15,),
                                ...
                                ChecklistController.to.chartSelections.contains(doc.id)
                                  ...
                                  child: Icon(Icons.stacked_bar_chart, color: Colors.orange.withOpacity(0.7).withOpacity(0.7),),
                                )
                                    : InkWell(
                                  onTap: () {
