...
import 'package:classdiary2/mobile/consultDetail.dart';
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    .collection('consult').where('email', isEqualTo: GetStorage().read('email')).orderBy('date', descending: true).snapshots(),
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (_, index) {
                      ...
                      return Padding(
                        ...
                        InkWell(
                          onTap: () {
                            // ConsultController.to.whereToGo.value = 'ConsultDetail';
                            Get.to(() => ConsultDetail(), arguments: 'update');
                            ConsultController.to.id = doc.id;
                            ConsultController.to.consultInput = doc['content'];
                          },
                          child: Row(
                            children: [
                              Column(
          ...
          children: [
            ...
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                Get.to(() => ConsultDetail(), arguments: 'add');
              },
