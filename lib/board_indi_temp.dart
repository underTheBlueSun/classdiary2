...
//   }
//
//   void fullScreenDialog(context, content, number, name, main_id) {
//     showDialog(
//       context: context,
//       barrierDismissible: false, // 다이얼로그 밖 클릭시 안사라지게
//       builder: (BuildContext context) {
...
//                           child: Image.asset('assets/images/bg05.png',),
//                         ),
//                       ),
//
...
//                                               Row(
//                                                 children: [
//                                                   Text(commentList[index]['name'], style: TextStyle(color: Colors.black, fontSize: 30),),
//                                                   // SizedBox(width: 2,),
...
//                                             ],
//                                           ),
//                                           Text(commentList[index]['comment'], style: TextStyle(fontSize: 40, color: Colors.redAccent,),),
//                                           SizedBox(height: 3,),
//                                         ],
//                                       );
//                                     }
...
//       //   centerTitle: false,
//       //   backgroundColor: Get.arguments['background'].length == 10 ?
//       //   Color(int.parse(Get.arguments['background'])) :
//       //   Color(appbar_colors[int.parse(Get.arguments['background'].substring(2,4))-1]),
//       //   elevation: 0,
//       //   title:
//       //   Padding(
...
//                             stream: FirebaseFirestore.instance.collection('board_indi').where('class_code', isEqualTo: GetStorage().read('class_code'))
//                                 .where('main_id', isEqualTo: Get.arguments['main_id']).where('number', isEqualTo: attendanceDoc['number'])
...
//                                                               Get.off(() => BoardUpdMoblie(), arguments: {'indiDoc' : indiDoc, 'type': 'indi', 'title' : Get.arguments['title'], 'main_id' : Get.arguments['main_id'], 'background': Get.arguments['background'],
...
//                   //                                             // Get.to(() => BoardUpdMoblie(), arguments: {'indiDoc' : indiDoc, 'type': 'indi', 'title' : Get.arguments['title'], 'main_id' : Get.arguments['main_id'], 'background': Get.arguments['background'],
//                   //                                             //   'content': Get.arguments['content'], 'id': Get.arguments['id'],}, );
//                   //                                           },
//                   //                                           child: Icon(Icons.edit_outlined, size: 20, color: Colors.black.withOpacity(0.3),)) :
//                   //                                       SizedBox(),
...
//           // BoardController.to.mainId = Get.arguments['main_id'];
//
...
//             'content': Get.arguments['content'], 'id': Get.arguments['id'], 'type': 'indi'});
//         },
//         child: Container(
//           decoration: BoxDecoration(color: Colors.orangeAccent, border: Border.all(color: Colors.white, width: 3), shape: BoxShape.circle,),
//           height: 70.0,
...
//                                 BoardController.to.addAllStamp(Get.arguments['main_id'], 'indi');
//                               }else {
//                                 BoardController.to.stamps.value = [];
//                                 BoardController.to.delAllStamp(Get.arguments['main_id'], 'indi');
//                               }
//                             },
...
//                                                                       BoardController.to.saveBoardIndi(Get.arguments['main_id'], attendanceDoc['number'],);
...
//                                                               InkWell(
//                                                                   onTap: () {
//                                                                     fullScreenDialog(context, indiDoc['content'], attendanceDoc['number'], attendanceDoc['name'], Get.arguments['main_id']);
//                                                                   },
//                                                                   child: Icon(Icons.fullscreen, size: 28, color: Colors.grey,)) : SizedBox(),
//
//                                                             ],
//                                                           ),
//                                                           SizedBox(height: 5,),
