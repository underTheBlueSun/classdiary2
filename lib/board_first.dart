...
// import 'board_indi2.dart';
// import 'controller/board_controller.dart';
//
// class BoardFirst extends StatelessWidget {
//
//   @override
//   Widget build(BuildContext context) {
//     return Obx(() => Scaffold(
//         backgroundColor: Color(0xFFF7F7F7),
//         body: BoardController.to.active_screen.value == 'board_main' ? BoardMain() :
//         BoardController.to.active_screen.value == 'board_indi' ? BoardIndi2() : SizedBox(),
//       ),
//     );
//
//   }
