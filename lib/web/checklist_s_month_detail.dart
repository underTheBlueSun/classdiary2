...
class ChecklistSMonthDetail extends StatelessWidget {
  String check_date;
  ChecklistSMonthDetail(this.check_date);
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        check_date.substring(5,7) == '13' ?
            Text('3월 ~ 현재까지') : Text(check_date.substring(5,7) + '월'),
        /// 3월~지금까지와 월간의 구분
        // int.parse(ChecklistController.to.selectedDate.substring(5,7)) > int.parse(DateTime.now().toString().substring(5,7)) ?
        check_date.substring(5,7) == '13' ?
        Container(
            ...
            child: SfCartesianChart(
                ...
                series: <LineSeries<ChartData, String>>[
                  LineSeries<ChartData, String>(
                      ...
                      xValueMapper: (ChartData data, _) => data.x.substring(8,10),
                      yValueMapper: (ChartData data, _) => data.y
                  )
                ]
            )
                  ...
                  return Container(
                    decoration: BoxDecoration(
                      border: Border(
                        ...
                        right: index % 2 == 0 ? BorderSide(width: 1, color: Colors.grey.withOpacity(0.5),)
