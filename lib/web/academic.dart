                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        //   child: Container(
                        //     width: 18,
                        //     child: Icon(Icons.calendar_month, color: Colors.teal.withOpacity(0.7), ),
                        //     // child: Icon(Icons.calendar_month, color: Colors.teal.withOpacity(0.7), ),
                        //   ),
                        // ),
    ...
    return StreamBuilder<QuerySnapshot>(
        ...
        return Obx(() => Container(
            ...
            child: SfCalendar(
              ...
              headerHeight: 50,
              // headerHeight: 20,
              headerStyle: CalendarHeaderStyle(textStyle: TextStyle(fontSize: 15, color: Colors.grey), textAlign: TextAlign.center), //  <    2023.03    >
              ...
              monthViewSettings: MonthViewSettings(
                ...
                appointmentDisplayCount:  2,  /// 2개까지 보여주기
                dayFormat: 'E', //  MON, TUE
                monthCellStyle:  MonthCellStyle(
                  textStyle: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.grey),
                    trailingDatesTextStyle: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.grey.withOpacity(0.5)),
                    leadingDatesTextStyle: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.grey.withOpacity(0.5)),
