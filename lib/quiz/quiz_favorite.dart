  ...
  Widget build(BuildContext context) {
    return Obx(() => Column(
        ...
        children: [
          ...
          Text('즐겨찾기', style: TextStyle(color: Color(0xff76B8C3), fontFamily: 'Jua', fontWeight: FontWeight.bold, fontSize: 35,),),
          SizedBox(height: 10,),
          StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance.collection('quiz_main').where('favorites', arrayContains: GetStorage().read('class_code')).snapshots(),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          onTap: () {
                                            QuizController.to.quiz_id = doc.id;
                                            QuizController.to.delFavorite(doc['favorites']);
                                            // QuizController.to.favorite_list.value = GetStorage().read('favorites');
                                            // QuizController.to.favorite_list.value.remove(doc.id);
                                            // GetStorage().write('favorites', QuizController.to.favorite_list.value);
                                          },
                                          child: Text('즐겨찾기 해제', style: TextStyle(color: Colors.black, fontFamily: 'Jua'),),
                                        ),
