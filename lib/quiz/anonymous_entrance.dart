...
class AnonymousEntrance extends StatelessWidget {
    ...
    return Center(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text('V 1.3', style: TextStyle(color: Colors.black),),
              SizedBox(height: 20,),
              Image.asset('assets/images/quiz_title.png', fit: BoxFit.cover, width: 200,),
              SizedBox(height: 20,),
              SizedBox(
                width: 330,
                child: TextField(
              ...
              // SizedBox(height: 10,),
              // Obx(() => Visibility(
              //       visible: QuizController.to.is_duplicate_name.value,
              //       child: Text('같은 이름이 존재합니다.', style: TextStyle(color: Colors.red, fontFamily: 'Jua'),),
              //   ),
              // ),
              SizedBox(height: 50,),
              Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    if (QuizController.to.nickname_input.trim().length > 2) {
                      QuizController.to.saveAnonymous();
                    }
                  },
                  child: Padding(
